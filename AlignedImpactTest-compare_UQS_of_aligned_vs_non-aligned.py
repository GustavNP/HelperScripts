...
aligned_scores_file = "output_files\\VGGFace200k-50-images-new-regions-blackout-only-filenames.csv"
non_aligned_scores_file = "C:\\Users\\admin\\source\\repos\\FaceSimilarity\\quality_score_files\\VGGFace2-200k-all-OFIQ-only-filenames.csv"
...
combined_df.hist(column='UQS_difference', bins=150, grid=True, rwidth=.9, color='purple')
